...
_NativeJsSendPort_send_closure: {"": "Closure;this_1,message_2,replyTo_3",
  call$0: function() {
    ...
    if (isolate == null)
      return;
    if (t2._receivePort.get$_liblib5$_callback() == null)
      return;
...
_NativeJsSendPort_send__closure: {"": "Closure;box_0,this_4,shouldSerialize_5",
  call$0: function() {
    ...
    if (t1.get$_liblib5$_callback() != null) {
...
Animator: {"": "Object;_running,_whenStarted,_callback,actors",
  ...
  static: {
Animator$: function() {
  var t1 = new R.Animator(false, null, null, []);
  t1.Animator$0();
  return t1;
}}
...
_BufferingStreamSubscription: {"": "Object;_zone<",
  ...
  _sendData$1: function(data) {
    var t1 = this._state;
    this._state = (t1 | 16) >>> 0;
    this._zone.runUnaryGuarded$2(this._liblib4$_onData, data);
    this._state = (this._state & 4294967279) >>> 0;
...
_AttributeClassSet: {"": "CssClassSetImpl;_liblib3$_element",
  readClasses$0: function() {
    ...
    classname = new W._ElementAttributeMap(this._liblib3$_element)._element.getAttribute("class");
    s = P.LinkedHashSet_LinkedHashSet(null, null, null, J.JSString);
    if (classname == null)
      return s;
  ...
  writeClasses$1: function(s) {
    new W._ElementAttributeMap(this._liblib3$_element)._element.setAttribute("class", s.join$1(s, " "));
  }
},
...
createBlocks: function() {
  ...
  for (i = 0; i < 13; ++i) {
    t1 = $.blocks;
    t2 = P.List_List(7, null);
    if (i >= t1.length)
      throw H.ioore(t1, i);
    t1[i] = t2;
    for (left = i * 68 + 8, j = 0; j < 7; ++j) {
...
checkBlocks: function() {
  var countBlocks, t1, blockNum, i, t2, t3, t4, i0, j, newColor, t5, t6, t7, k;
  countBlocks = G.findBlocks();
  for (t1 = countBlocks.length, blockNum = 0, i = 0; i < 13; i = i0)
    for (t2 = i < 12, t3 = i > 0, t4 = i - 1, i0 = i + 1, j = 0; j < 7; ++j) {
      newColor = [1, 1, 1, 1, 1];
      if (i >= t1)
      ...
      if (t5) {
        ...
        if (j > 0) {
          ...
          if (t6 >= t5.length)
            throw H.ioore(t5, t6);
          t6 = t5[t6].get$colorNum();
          if (t6 == null)
            throw t6.$sub();
          t6 -= 11;
          if (t6 < 0 || t6 >= 5)
            throw H.ioore(newColor, t6);
          newColor[t6] = 0;
        }
        if (t2) {
          t5 = $.blocks;
...
findBlocks: function() {
  var countBlocks, t1, i, t2, t3, t4, j, t5, t6, t7, t8;
  countBlocks = P.List_List(13, null);
  for (t1 = countBlocks.length, i = 0; i < 13; ++i) {
    t2 = P.List_List(7, null);
    if (i >= t1)
      throw H.ioore(countBlocks, i);
    countBlocks[i] = t2;
    for (t2 = i === 0, t3 = !t2, t4 = i - 1, j = 0; j < 7; ++j) {
      t5 = countBlocks[i];
      if (j >= t5.length)
        throw H.ioore(t5, j);
      t5[j] = new G.CountBlock(null, null);
      if (t2) {
        t5 = countBlocks[i];
        if (j >= t5.length)
          throw H.ioore(t5, j);
        t5[j].set$countColumn(1);
      }
      t5 = j === 0;
      if (t5) {
        t6 = countBlocks[i];
      ...
      if (t3) {
        ...
        if (t6) {
          ...
          t6 = t7[j];
          if (t4 >= t1)
            throw H.ioore(countBlocks, t4);
          t7 = countBlocks[t4];
          if (j >= t7.length)
            throw H.ioore(t7, j);
          t7 = t7[j].get$countColumn();
          if (typeof t7 !== "number")
            throw t7.$add();
          t6.set$countColumn(t7 + 1);
        } else {
          if (j >= t7.length)
            throw H.ioore(t7, j);
          t7[j].set$countColumn(1);
        }
      }
      if (!t5) {
        t5 = $.blocks;
...
Eye: {"": "Object;_block@,_img@,_clickedImg@,_specialImg,_status@,colorNum@,count@,skillOn@,falling@,posX@,posY@,top>,left>",
  ...
  beClicked$0: function() {
    var t1 = J.get$classes$x(this._img);
    t1.add$1(t1, "disappear");
    t1 = J.get$classes$x(this._clickedImg);
    t1.remove$1(t1, "disappear");
    t1 = J.get$classes$x(this._block);
    t1.add$1(t1, "clicked");
  },
  cancelClicked$0: function() {
    var t1 = J.get$classes$x(this._img);
    t1.remove$1(t1, "disappear");
    t1 = J.get$classes$x(this._clickedImg);
    t1.add$1(t1, "disappear");
    t1 = J.get$classes$x(this._block);
    t1.remove$1(t1, "clicked");
  },
  swap$1: function(another) {
    var temp = this._block;
    this._block = another.get$_block();
    another.set$_block(temp);
    temp = this.colorNum;
    this.colorNum = another.get$colorNum();
    another.set$colorNum(temp);
    temp = this._img;
    this._img = another.get$_img();
    another.set$_img(temp);
    temp = this._clickedImg;
    this._clickedImg = another.get$_clickedImg();
    another.set$_clickedImg(temp);
    temp = this._status;
    this._status = another.get$_status();
    another.set$_status(temp);
    temp = this.skillOn;
    this.skillOn = another.get$skillOn();
    another.set$skillOn(temp);
    temp = this.falling;
    this.falling = another.get$falling();
    another.set$falling(temp);
  },
  equel$1: function(another) {
    this._block = another._block;
    this.colorNum = another.colorNum;
    this._status = another._status;
  ...
  destory$0: function() {
    if (this.colorNum == null)
      return;
    J.remove$0$ax(this._block);
    this._block = null;
    this.colorNum = null;
    this.count = false;
  },
  addColor$1: function(color) {
    var t1, t2;
    t1 = $.get$blockColor();
    if (color == null)
      throw color.$sub();
    ...
    if (t2 < 0 || t2 >= 5)
      throw H.ioore(t1, t2);
    this._img = W.Element_Element$html("<img src=\"static/" + t1[t2] + "02.png\">", null, null);
    this._clickedImg = W.Element_Element$html("<img src=\"static/" + $.get$blockColor()[t2] + "Clicked.png\">", null, null);
    t2 = J.get$classes$x(this._clickedImg);
    t2.add$1(t2, "disappear");
    J.get$nodes$x(this._block)._this.appendChild(this._img);
    J.get$nodes$x(this._block)._this.appendChild(this._clickedImg);
  },
  besideClicked$1: function(another) {
    var t1, t2, t3, t4, t5;
    t1 = this.posX;
    t2 = another.get$posX();
    t3 = t1 == null ? t2 == null : t1 === t2;
    if (t3) {
      t4 = another.get$posY();
      t5 = this.posY;
      if (t5 == null)
  ...
  create$0: function() {
    this._block = W.Element_Element$html("<div class=\"block\"></div>", null, null);
    var t1 = $.parent;
    t1.get$nodes;
    new W._ChildNodeListLazy(t1)._this.appendChild(this._block);
    J.set$top$x(J.get$style$x(this._block), H.S(this.top) + "px");
    J.set$left$x(J.get$style$x(this._block), "" + this.left + "px");
    this.addColor$1(this.colorNum);
  },
  static: {
"": "Eye_NORMAL,Eye_BOMB,Eye_THUNDER,Eye_COLORCLEAN,Eye_BLUE,Eye_GREEN,Eye_PURPLE,Eye_RED,Eye_YELLOW",
}

},

CountBlock: {"": "Object;countColumn@,countRow@"},
...
CleanColor: {"": "Object;color,times,a",
  next$1: function(time) {
    ...
    if (this.times === 0) {
      ...
      t1 = J.get$classes$x(this.a._img);
      t1.add$1(t1, "rotateToDispear");
    }
...
GameManager: {"": "Object;end,executing,falling@,shakeTimes,cleanTimes",
  controlremover$0: function() {
    var countBlocks, t1, crushBlocks, crush, i, j, t2, k, t3, t4;
    this.cleanTimes = this.cleanTimes + 1;
    countBlocks = G.findBlocks();
    for (t1 = countBlocks.length, crushBlocks = 0, crush = false, i = 12; i >= 0; --i)
      for (j = 6; j >= 0; --j) {
        if (i >= t1)
          throw H.ioore(countBlocks, i);
        t2 = countBlocks[i];
    ...
    t1 = $.get$stageManager();
    t1.score = t1.score + crushBlocks * this.cleanTimes * 100;
    return crush;
  },
  next$1: function(time) {
    var t1, t2, i, j;
    if ($.get$stageManager().stage === 0) {
      ...
      if (t1.$ge(time, 363800)) {
        ...
        if (t1 > 3) {
          ...
          this.shakeTimes = t1 + 1;
      }
    }
  }
},

Changer: {"": "Object;a,b,wholeTime,direction,velocity,firstCall,changeTimes",
  _pickEyes$2: function(_a, _b) {
    var t1, t2;
    t1 = _a.get$posX();
    t2 = _b.get$posX();
    if (t1 == null)
  ...
  report$0: function() {
    ...
    if (!(boolA || boolB)) {
      ...
      this.changeTimes = t1 + 1;
      this._pickEyes$2(this.a, this.b);
      this.firstCall = null;
    } else {
      C.JSArray_methods.remove$1($.get$animator().actors, this);
      $.get$animator().actors.push(new G.ControlFaller(0));
  ...
  next$1: function(time) {
    ...
    if (this.firstCall == null)
      this.firstCall = time;
    t1 = J.getInterceptor$n(time);
    if (J.$ge$n(t1.$sub(time, this.firstCall), this.wholeTime)) {
      t1 = this.direction;
      t2 = this.a;
      if (t1 === 0) {
        J.set$top$x(J.get$style$x(t2._block), H.S(this.a.top + 68) + "px");
        J.set$top$x(J.get$style$x(this.b._block), H.S(this.b.top - 68) + "px");
      } else {
        J.set$left$x(J.get$style$x(t2._block), "" + (this.a.left + 68) + "px");
        J.set$left$x(J.get$style$x(this.b._block), "" + (this.b.left - 68) + "px");
      }
      this.a.cancelClicked$0();
      this.b.cancelClicked$0();
      this.a.swap$1(this.b);
      this.report$0();
      return;
    }
    t2 = this.direction;
    t3 = this.a;
    if (t2 === 0) {
      t2 = J.get$style$x(t3._block);
      t3 = this.a.top;
      t4 = this.velocity;
      t5 = t1.$sub(time, this.firstCall);
      if (typeof t5 !== "number")
        throw H.iae(t5);
      J.set$top$x(t2, H.S(t3 + t4 * t5) + "px");
      t5 = J.get$style$x(this.b._block);
      t4 = this.b.top;
      t3 = this.velocity;
      t1 = t1.$sub(time, this.firstCall);
      if (typeof t1 !== "number")
        throw H.iae(t1);
      J.set$top$x(t5, H.S(t4 - t3 * t1) + "px");
    } else {
      t2 = J.get$style$x(t3._block);
      t3 = this.a.left;
      t4 = this.velocity;
      ...
      if (typeof t5 !== "number")
        throw H.iae(t5);
      J.set$left$x(t2, H.S(t3 + t4 * t5) + "px");
      t5 = J.get$style$x(this.b._block);
      t4 = this.b.left;
      t3 = this.velocity;
      t1 = t1.$sub(time, this.firstCall);
      if (typeof t1 !== "number")
        throw H.iae(t1);
      J.set$left$x(t5, H.S(t4 - t3 * t1) + "px");
    }
  },
  Changer$1: function(milliseconds) {
    this.wholeTime = milliseconds;
    this.velocity = 68 / milliseconds;
  },
  static: {
"": "Changer_UP,Changer_LEFT",
Changer$: function(milliseconds) {
  var t1 = new G.Changer(null, null, null, null, null, null, 0);
  t1.Changer$1(milliseconds);
  return t1;
}}

},

Remover: {"": "Object;callTimes,removed",
  next$1: function(time) {
    var t1;
    if (this.callTimes >= 10) {
      t1 = this.removed;
      if (J.get$status$x(t1) !== 0 && !t1.get$skillOn())
        ;
      else if (t1.get$colorNum() != null)
        t1.destory$0();
      C.JSArray_methods.remove$1($.get$animator().actors, this);
    }
...
Score: {"": "Object;times,showScore",
  next$1: function(time) {
    if (this.times > 3) {
      this.times = 0;
      this.showScore.textContent = "" + $.get$stageManager().score;
    }
    this.times = this.times + 1;
  }
},

Faller: {"": "Object;falling@,startingPoint,distance,velocity,firstCall,wholeTime,perTime",
  next$1: function(time) {
    var t1, t2, t3, t4;
    t1 = this.falling;
    if (t1.get$colorNum() == null) {
      t1.set$falling(false);
      C.JSArray_methods.remove$1($.get$animator().actors, this);
      return;
    }
    t1 = this.firstCall;
    if (t1 == null)
      ...
      t1 = J.$ge$n(t2.$sub(time, t1), this.wholeTime);
      t3 = this.falling;
      if (t1) {
        J.set$top$x(J.get$style$x(t3.get$_block()), H.S(J.get$top$x(this.falling)) + "px");
        this.falling.set$falling(false);
        C.JSArray_methods.remove$1($.get$animator().actors, this);
      } else {
        t1 = J.get$style$x(t3.get$_block());
        t3 = this.startingPoint;
        t4 = this.velocity;
        t2 = t2.$sub(time, this.firstCall);
        if (typeof t2 !== "number")
          throw H.iae(t2);
        J.set$top$x(t1, H.S(J.$add$ns(t3, C.JSNumber_methods.toInt$0(t4 * t2))) + "px");
      }
    }
  },
  Faller$3: function(a, fallNum, $top) {
    var t1;
    this.falling = a;
    this.distance = fallNum * 68;
    t1 = this.perTime;
    this.wholeTime = t1 * fallNum;
    this.velocity = 68 / t1;
    this.startingPoint = $top;
    a.set$falling(true);
  },
  static: {
Faller$: function(a, fallNum, $top) {
  var t1 = new G.Faller(null, null, null, null, null, null, 200);
  t1.Faller$3(a, fallNum, $top);
  return t1;
}}
...
ControlFaller: {"": "Object;times",
  next$1: function(time) {
    ...
    for (max = 0, i = 0; i < 13; ++i)
      for (leftOfEye = 8 + 68 * i, $top = null, newDiv = 0, j = 6; j >= 0; --j) {
        t1 = $.blocks;
        if (i >= t1.length)
          throw H.ioore(t1, i);
        t1 = t1[i];
        ...
        if (t3.get$colorNum() == null) {
          ...
          if (nullNum !== 0) {
            ...
            if (t4 < 0) {
              ...
              $.get$random().nextInt$1;
              eye = new G.Eye(null, null, null, null, 0, (Math.random() * 5 >>> 0) + 11, false, false, false, null, null, topOfEye, leftOfEye);
              eye.create$0();
              t1 = $.blocks;
              if (i >= t1.length)
                throw H.ioore(t1, i);
...
Startor: {"": "Object;displacement,a1,a2,a3,a4,dis,dis2,vMax,_vMax",
  next$1: function(time) {
    var t1 = J.getInterceptor$n(time);
    if (t1.$ge(time, 3800)) {
      t1 = J.get$classes$x(document.querySelector("#start"));
      t1.remove$1(t1, "rotate");
      t1 = J.get$classes$x(document.querySelector("#start"));
      t1.add$1(t1, "disappear");
      t1 = J.get$classes$x(document.querySelector("#numS"));
      t1.add$1(t1, "disappear");
      t1 = J.get$classes$x(document.querySelector("#bigShield"));
      t1.add$1(t1, "disappear");
      C.JSArray_methods.remove$1($.get$animator().actors, this);
      return;
    } else if (t1.$ge(time, 2600)) {
      t1 = J.get$classes$x(document.querySelector("#numS"));
      t1.remove$1(t1, "disappear");
      t1 = J.get$classes$x(document.querySelector("#num1"));
      t1.add$1(t1, "disappear");
    } else if (t1.$ge(time, 1800)) {
      t1 = J.get$classes$x(document.querySelector("#num1"));
      t1.remove$1(t1, "disappear");
      t1 = J.get$classes$x(document.querySelector("#num2"));
      t1.add$1(t1, "disappear");
    } else if (t1.$ge(time, 1000)) {
      t1 = J.get$classes$x(document.querySelector("#num2"));
      t1.remove$1(t1, "disappear");
      t1 = J.get$classes$x(document.querySelector("#num3"));
      t1.add$1(t1, "disappear");
    } else if (t1.$ge(time, 200)) {
      t1 = J.get$classes$x(document.querySelector("#start"));
      t1.add$1(t1, "rotate");
      t1 = J.get$classes$x(document.querySelector("#num3"));
      t1.remove$1(t1, "disappear");
  ...
  Startor$0: function() {
    this.a1 = 0.0018;
    this.a2 = 0.0008470588235294117;
    this.dis = 20.16;
    this._vMax = this.dis / 136;
    this.a3 = this._vMax / 16;
    this.a4 = this._vMax / 120;
    this.vMax = 1.44;
  },
  static: {
Startor$: function() {
  var t1 = new G.Startor(null, null, null, null, null, null, null, null, null);
  t1.Startor$0();
  return t1;
}}
...
ControlEnder: {"": "Object;firstCall,stage",
  next$1: function(time) {
    ...
    if (t1 == null)
      ...
      t1.remove$1(t1, "disappear");
      t1 = J.get$classes$x(document.querySelector("#scoreShow"));
      t1.remove$1(t1, "scoreShow2");
      t1 = J.get$classes$x(document.querySelector("#score2"));
      t1.remove$1(t1, "score3");
      t1 = J.get$classes$x(document.querySelector("#score2"));
      t1.add$1(t1, "disappear");
      t1 = J.get$classes$x(document.querySelector("#scoreShow"));
      t1.add$1(t1, "disappear");
...
StageManager: {"": "Object;sthClicked,firstClicked,secondClicked,stage,score,rank,usrName,firstStart",
  onBorder$2: function(x, y) {
    var t1 = C.JSNumber_methods.$mod(x, 68);
    if (t1 > 0 && t1 < 8)
      return true;
    t1 = C.JSNumber_methods.$mod(y, 68);
    if (t1 > 0 && t1 < 8)
      return true;
    return false;
  },
  setStage$0: function() {
    ...
    if (t2 - 110 >= 861) {
      ...
      t2 = "861px";
    J.set$top$x(t1, t2);
    t2 = document.querySelector("#submitboard").style;
  ...
  setOutput$0: function() {
    var t1, t2, i;
    t1 = document.querySelector("#output").style;
    t2 = window.innerHeight;
    if (t2 == null)
      throw t2.$sub();
    if (t2 - 110 >= 861) {
      ...
      t2 = "711px";
    J.set$height$x(t1, t2);
    t2 = document.querySelector("#rank").style;
    t1 = window.innerWidth;
    if (t1 == null)
      throw t1.$sub();
    J.set$left$x(t2, "" + ((t1 - 910) / 2 + 500) + "px");
    for (i = 0; i < 5; ++i) {
      t1 = "#monster" + i;
      ...
      if (t2 == null)
        throw t2.$sub();
      J.set$left$x(t1, "" + (t2 - 930) / 2 + "px");
    }
    t1 = document.querySelector("#re2").style;
    t2 = window.innerWidth;
    if (t2 == null)
      throw t2.$sub();
    J.set$left$x(t1, "" + ((t2 - 910) / 2 + 565) + "px");
    t2 = document.querySelector("#lastscore").style;
    t1 = window.innerWidth;
    if (t1 == null)
      throw t1.$sub();
    J.set$left$x(t2, "" + ((t1 - 910) / 2 + 760) + "px");
    t1 = document.querySelector("#scoreNum").style;
    t2 = window.innerWidth;
    if (t2 == null)
      throw t2.$sub();
  ...
  setRestart$0: function() {
    var t1, t2;
    t1 = document.querySelector("#re2");
    t1.get$onClick;
    t1 = new W._ElementEventStreamImpl(t1, C.EventStreamProvider_click._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._EventStreamSubscription__wrapZone(new G.StageManager_setRestart_closure()), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
  },
  setEvent$0: function() {
    var submit, t1, t2, t3, t4;
    submit = document.querySelector("#sbmt");
    submit.get$onMouseOver;
    t1 = C.EventStreamProvider_mouseover._eventType;
    t2 = new W._ElementEventStreamImpl(submit, t1, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._EventStreamSubscription__wrapZone(new G.StageManager_setEvent_closure(submit)), t2._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t3._tryResume$0();
    t3 = C.EventStreamProvider_mouseout._eventType;
    t2 = new W._ElementEventStreamImpl(submit, t3, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t4 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._EventStreamSubscription__wrapZone(new G.StageManager_setEvent_closure0(submit)), t2._useCapture);
    H.setRuntimeTypeInfo(t4, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t4._tryResume$0();
    t4 = new W._ElementEventStreamImpl(submit, C.EventStreamProvider_click._eventType, false);
    H.setRuntimeTypeInfo(t4, [null]);
    t2 = new W._EventStreamSubscription(0, t4._target, t4._eventType, W._EventStreamSubscription__wrapZone(new G.StageManager_setEvent_closure1(this)), t4._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t4, "_EventStream", 0)]);
    t2._tryResume$0();
    t1 = new W._ElementEventStreamImpl(submit, t1, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._EventStreamSubscription__wrapZone(new G.StageManager_setEvent_closure2(submit)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t3 = new W._ElementEventStreamImpl(submit, t3, false);
    H.setRuntimeTypeInfo(t3, [null]);
    t2 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._EventStreamSubscription__wrapZone(new G.StageManager_setEvent_closure3(submit)), t3._useCapture);
    ...
    H.setRuntimeTypeInfo(t2, [null]);
    t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._EventStreamSubscription__wrapZone(new G.StageManager_setEvent_closure4(this)), t2._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t3._tryResume$0();
  },
  ...
  setTimer$0: function() {
    ...
    for (i = 0; i < 10; ++i) {
      ...
      J.set$left$x(J.get$style$x($.get$bats()[i]), "" + (1 + i * 68) + "px");
      img = W.Element_Element$html("<img src=\"static/bat00.png\">", null, null);
      t1 = J.getInterceptor$x(img);
      J.set$width$x(t1.get$style(img), "30px");
      J.set$left$x(t1.get$style(img), "25px");
      J.get$nodes$x($.get$bats()[i])._this.appendChild(img);
      _parent.get$nodes;
...
StageManager_setRestart_closure: {"": "Closure;",
  call$1: function(evt) {
    var t1 = J.get$classes$x(document.querySelector("#output"));
    t1.add$1(t1, "disappear");
    G.restart();
  }
},

StageManager_setEvent_closure: {"": "Closure;submit_0",
  call$1: function(evt) {
    var t1, t2, t3;
    t1 = this.submit_0;
    t2 = t1.style;
    ...
    if (t3 == null)
      throw t3.$sub();
    J.set$left$x(t2, "" + ((t3 - 540) / 2 + 433) + "px");
    J.set$top$x(t1.style, "262px");
    J.set$width$x(t1.style, "104px");
  }
},

StageManager_setEvent_closure0: {"": "Closure;submit_1",
  call$1: function(evt) {
    var t1, t2, t3;
    t1 = this.submit_1;
    t2 = t1.style;
    ...
    if (t3 == null)
      throw t3.$sub();
    J.set$left$x(t2, "" + ((t3 - 540) / 2 + 430) + "px");
    J.set$top$x(t1.style, "260px");
    J.set$width$x(t1.style, "110px");
  }
},

StageManager_setEvent_closure1: {"": "Closure;this_2",
  call$1: function(evt) {
    var t1, t2;
    t1 = J.get$value$x(document.querySelector("#input"));
    if (t1 !== "") {
      t2 = this.this_2;
      t2.usrName = t1;
      ...
      t1 = new W._ElementEventStreamImpl(t1, C.EventStreamProvider_click._eventType, false);
      H.setRuntimeTypeInfo(t1, [null]);
      t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._EventStreamSubscription__wrapZone(new G.StageManager_setEvent__closure(t2)), t1._useCapture);
      H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
      t2._tryResume$0();
    } else {
      t1 = J.get$classes$x(document.querySelector("#bloodSubmit"));
      t1.remove$1(t1, "disappear");
      P.Timer_Timer(P.Duration$(0, 0, 0, 0, 0, 1), new G.StageManager_setEvent__closure0());
    }
  }
},
...
StageManager_setEvent__closure0: {"": "Closure;",
  call$0: function() {
    var t1 = J.get$classes$x(document.querySelector("#bloodSubmit"));
    t1.add$1(t1, "disappear");
  },
  $is_void_: true
},

StageManager_setEvent_closure2: {"": "Closure;submit_4",
  call$1: function(evt) {
    var t1, t2, t3;
    t1 = this.submit_4;
    t2 = t1.style;
...
StageManager_setEvent_closure3: {"": "Closure;submit_5",
  call$1: function(evt) {
    var t1, t2, t3;
    t1 = this.submit_5;
    t2 = t1.style;
...
StageManager_setEvent_closure4: {"": "Closure;this_6",
  call$1: function(evt) {
    var t1, t2;
    if (J.get$keyCode$x(evt) === 13) {
      t1 = J.get$value$x(document.querySelector("#input"));
      if (t1 !== "") {
        t2 = this.this_6;
        t2.usrName = t1;
        ...
        t1 = new W._ElementEventStreamImpl(t1, C.EventStreamProvider_click._eventType, false);
        H.setRuntimeTypeInfo(t1, [null]);
        t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._EventStreamSubscription__wrapZone(new G.StageManager_setEvent__closure1(t2)), t1._useCapture);
        H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
        t2._tryResume$0();
      } else {
        t1 = J.get$classes$x(document.querySelector("#bloodSubmit"));
        t1.remove$1(t1, "disappear");
        P.Timer_Timer(P.Duration$(0, 0, 0, 0, 0, 1), new G.StageManager_setEvent__closure2());
      }
    }
  }
},
...
StageManager_setEvent__closure2: {"": "Closure;",
  call$0: function() {
    var t1 = J.get$classes$x(document.querySelector("#bloodSubmit"));
    t1.add$1(t1, "disappear");
  },
...
StageManager_setEvent2_closure: {"": "Closure;this_0",
  call$1: function($event) {
    var t1, t2, t3, clickPosX, clickPosY, changer;
    t1 = J.getInterceptor$x($event);
    t2 = J.get$x$x(t1.get$page($event));
    t3 = $.pos.offsetLeft;
    if (typeof t2 !== "number")
      throw t2.$sub();
    if (t3 == null)
      throw H.iae(t3);
    clickPosX = C.JSNumber_methods.toInt$0(t2 - t3);
    t1 = J.get$y$x(t1.get$page($event));
    t3 = $.pos.offsetTop;
    if (typeof t1 !== "number")
      throw t1.$sub();
    if (t3 == null)
      throw H.iae(t3);
    clickPosY = C.JSNumber_methods.toInt$0(t1 - t3);
    t1 = this.this_0;
    if (t1.onBorder$2(clickPosX, clickPosY))
      return;
    clickPosX = C.JSNumber_methods.$tdiv(clickPosX, 68);
    clickPosY = C.JSNumber_methods.$tdiv(clickPosY, 68);
    t2 = $.blocks;
...
StageManager_setEvent2_closure1: {"": "Closure;",
  call$1: function($event) {
    G.restart();
  }
}}],
...
["main.dart", "main.dart", , F, {
main: function() {
  $.get$stageManager().setStage$0();
  $.get$stageManager().setEvent$0();
}},
1],
]);
...
R.Actor.$isActor = true;
R.Actor.$isObject = true;
...
Isolate.$lazy($, "blockColor", "blockColor", "get$blockColor", function() {
  return ["red", "yellow", "blue", "green", "purple"];
});
Isolate.$lazy($, "animator", "animator", "get$animator", function() {
  return R.Animator$();
});
Isolate.$lazy($, "random", "random", "get$random", function() {
  return C.C__Random;
});
Isolate.$lazy($, "gameManager", "gameManager", "get$gameManager", function() {
  return new G.GameManager(false, false, false, 0, 1);
});
Isolate.$lazy($, "stageManager", "stageManager", "get$stageManager", function() {
  return new G.StageManager(false, null, null, 0, 0, null, null, true);
});
