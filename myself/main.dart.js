...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, height, width, mainElement;
    t1 = [];
    t1.push(document.querySelector(".img0"));
    t1.push(document.querySelector(".img1"));
    t1.push(document.querySelector(".img2"));
    $.imgs = t1;
    height = window.innerHeight;
    width = window.innerWidth;
    mainElement = document.querySelector(".main");
    t1 = mainElement.style;
    if (typeof height !== "number")
      return height.$sub();
    J.set$top$x(t1, C.JSInt_methods.toString$0(C.JSInt_methods._tdivFast$1(height - 400, 2)) + "px");
    t1 = mainElement.style;
    if (typeof width !== "number")
      return width.$sub();
    J.set$left$x(t1, C.JSInt_methods.toString$0(C.JSInt_methods._tdivFast$1(width - 800, 2)) + "px");
    F.initEvent();
  }, "call$0", "main$closure", 0, 0, 1],
  initEvent: function() {
    var t1 = J.get$onClick$x(document.querySelector(".left"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.initEvent_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector(".right"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.initEvent_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onMouseOver$x(document.querySelector(".displayBox"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.initEvent_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onMouseOut$x(document.querySelector(".displayBox"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.initEvent_closure2()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector(".goto"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.initEvent_closure3()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  flipLeft: function() {
    J.get$classes$x(document.querySelector(".images")).add$1(0, "flip_animation");
    P.Timer_Timer(C.Duration_750000, new F.flipLeft_closure());
    P.Timer_Timer(C.Duration_1500000, new F.flipLeft_closure0());
  },
  flipRight: function() {
    J.get$classes$x(document.querySelector(".images")).add$1(0, "flip_animation");
    P.Timer_Timer(C.Duration_750000, new F.flipRight_closure());
    P.Timer_Timer(C.Duration_1500000, new F.flipRight_closure0());
  },
  getLeft: function(n) {
    if (n === 0)
      return 2;
  ...
  initEvent_closure1: {
    "^": "Closure:9;",
    call$1: function(_) {
      J.get$classes$x(document.querySelector(".mask")).add$1(0, "mask_hover");
      J.get$classes$x(document.querySelector(".title")).add$1(0, "title_hover");
      J.get$classes$x(document.querySelector(".goto")).remove$1(0, "disappear");
    }
  },
  initEvent_closure2: {
    "^": "Closure:9;",
    call$1: function(_) {
      J.get$classes$x(document.querySelector(".mask")).remove$1(0, "mask_hover");
      J.get$classes$x(document.querySelector(".title")).remove$1(0, "title_hover");
      J.get$classes$x(document.querySelector(".goto")).add$1(0, "disappear");
    }
  },
  initEvent_closure3: {
    "^": "Closure:9;",
    call$1: function(_) {
      ...
      t2 = $.nowPage;
      if (t2 === 0)
        t2 = "https://www.dropbox.com/sh/mte5lbcd1sjlvxz/AADSNwkwB3dKqsdr1YtnOXHNa?dl=0";
      else
        t2 = t2 === 1 ? "http://leafinity.github.io/arbo/" : "http://leafinity.github.io/eyeBurst/";
      t1.replace(t2);
    }
  },
  flipLeft_closure: {
    ...
    call$0: function() {
      ...
      if (t2 < 0 || t2 >= t1.length)
        return H.ioore(t1, t2);
      J.get$classes$x(t1[t2]).add$1(0, "disappear");
      $.nowPage = F.getLeft($.nowPage);
      t2 = document.querySelector(".title");
      t1 = $.get$text();
      t3 = $.nowPage;
      if (t3 < 0 || t3 >= 3)
        return H.ioore(t1, t3);
      J.set$innerHtml$x(t2, t1[t3]);
      t3 = $.imgs;
      t1 = $.nowPage;
      if (t1 < 0 || t1 >= t3.length)
        return H.ioore(t3, t1);
      J.get$classes$x(t3[t1]).remove$1(0, "disappear");
    }
  },
  flipLeft_closure0: {
    "^": "Closure:7;",
    call$0: function() {
      J.get$classes$x(document.querySelector(".images")).remove$1(0, "flip_animation");
    }
  },
  flipRight_closure: {
    "^": "Closure:7;",
...
Isolate.$lazy($, "text", "text", "get$text", function() {
  return ["Art Works", "Website 1", "Website 2"];
});
