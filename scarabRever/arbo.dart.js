...
["", "arbo.dart", , T, {
main: function() {
  var t1, t2, t3, t4, t5, vb;
  t1 = document.querySelector("#chessboard");
  t2 = document.querySelector("#memo");
  t3 = document.querySelector("#score_b");
  t4 = document.querySelector("#score_w");
  t5 = document.querySelector("#alert");
  vb = new T.VisualBoard(t1, null, P.List_List(8, null), new T.Dialog(null, null, t2), new T.ScoreBoard(t3, t4, null, null), new T.Alert(t5, 0, 0), new T.ComputerPlayer(null, null), false, null, 1, 2, 5, null);
  vb._init$0();
  vb._initElements$0();
  vb._choosePlayer$0();
  vb._chooseLevel$0();
  vb._initEvents$0();
  vb._scoreboard.setScore$1(vb._board);
}},
1],
...
["reversi", "reversi.dart", , T, {
Cell: {"": "Object;_parent,_reversi$_cell,_chess,_blackChess,_whiteChess,top,left,_horz,_ver",
  create$0: function() {
    var t1, t2;
    t1 = this._parent;
    t1.toString;
    t2 = W.Element_Element$html("<div class = \"ch_child " + this._horz + " " + this._ver + "\"></div>", null, null);
    this._reversi$_cell = t2;
    new W._ChildNodeListLazy(t1)._this.appendChild(t2);
    J.set$top$x(J.get$style$x(this._reversi$_cell), "" + this.top + "px");
    J.set$left$x(J.get$style$x(this._reversi$_cell), "" + this.left + "px");
  },
  addChess$1: function(color) {
    var t1, t2, t3;
    t1 = J.get$nodes$x(this._reversi$_cell);
    t2 = color === C.Color_Black;
    t3 = W.Element_Element$html("<div class=\"" + (t2 ? "b" : "w") + "c\"></div>", null, null);
    this._chess = t3;
    t1._this.appendChild(t3);
    t3 = J.get$nodes$x(this._chess);
    t1 = W.ImageElement_ImageElement(86, "static/b.png", 86);
    this._blackChess = t1;
    t3._this.appendChild(t1);
    t1 = J.get$nodes$x(this._chess);
    t3 = W.ImageElement_ImageElement(76, "static/w.png", 76);
    this._whiteChess = t3;
    t1._this.appendChild(t3);
    if (t2) {
      t1 = J.get$classes$x(this._whiteChess);
      t1.add$1(t1, "disappear");
    } else {
      t1 = J.get$classes$x(this._blackChess);
      t1.add$1(t1, "disappear");
    }
    t1 = J.get$classes$x(this._reversi$_cell);
    t1.remove$1(t1, "can_set");
    t1 = J.get$classes$x(this._chess);
    t1.add$1(t1, "lastest");
    P.Timer_Timer(C.Duration_3000000, new T.Cell_addChess_closure(this));
  },
  changeChess$1: function(next) {
    var t1 = this._chess;
    if (next === C.Color_Black) {
  ...
  addHintAnimation$0: function() {
    var t1 = J.get$classes$x(this._reversi$_cell);
    t1.add$1(t1, "hint");
  },
  removeHintAnimation$0: function() {
    var t1 = J.get$classes$x(this._reversi$_cell);
    t1.remove$1(t1, "hint");
  },
  canSet$0: function() {
  ...
  cannotSet$0: function() {
    var t1 = J.get$classes$x(this._reversi$_cell);
    t1.remove$1(t1, "can_set");
  }
},

Cell_addChess_closure: {"": "Closure;this_0",
  call$0: function() {
    var t1 = J.get$classes$x(this.this_0._chess);
    t1.remove$1(t1, "lastest");
  }
},
...
Offset: {"": "Object;x>,y>",
  $eq: function(_, other) {
    ...
    if (other == null)
      return false;
    t1 = J.getInterceptor(other);
    if (typeof other === "object" && other !== null && !!t1.$isOffset)
      return this.x === other.x && this.y === other.y;
    if (typeof other === "object" && other !== null && (other.constructor === Array || !!t1.$isList) && t1.get$length(other) === 2)
      return this.x === t1.$index(other, 0) && this.y === t1.$index(other, 1);
    return false;
  },
  get$hashCode: function(_) {
...
Board: {"": "Object;_board",
  _init$0: function() {
    var i, t1, t2;
    this._board = P.List_List(8, null);
    for (i = 0; i < 8; ++i) {
      t1 = this._board;
      t2 = P.List_List(8, null);
      t1.length;
      t1[i] = t2;
    }
  },
  canPlace$2: function(pos, color) {
    ...
    if (t1 >>> 0 !== t1 || t1 >= 8)
      throw H.ioore(t2, t1);
    if (t2[t1] == null)
      for (t1 = new H.ListIterator($.get$_allOfs(), 8, 0, null); t1.moveNext$0();)
        if (this._placeLine$4$checkOnly(pos, t1._current, color, true))
          return true;
    return false;
  },
  placeChess$2: function(pos, color) {
    var t1;
    for (t1 = new H.ListIterator($.get$_allOfs(), 8, 0, null); t1.moveNext$0();)
      this._placeLine$3(pos, t1._current, color);
  },
  _placeLine$4$checkOnly: function(pos, ofs, color, checkOnly) {
    var t1, t2, t3, t4, t5, p;
    t1 = pos.x;
    t2 = J.getInterceptor$x(ofs);
    t3 = t2.get$x(ofs);
    if (typeof t3 !== "number")
      throw H.iae(t3);
    t4 = pos.y;
  ...
  boardFull$0: function() {
    var t1, i, t2, j;
    for (t1 = this._board, i = 0; i < 8; ++i)
      for (t2 = t1[i], j = 0; j < 8; ++j) {
        t1.length;
        t2.length;
        if (t2[j] == null)
          return false;
...
ScoreBoard: {"": "Object;_black,_white,_blackscore,_whitescore",
  setScore$1: function(_board) {
    ...
    this._black.textContent = H.S(this._blackscore);
    this._white.textContent = H.S(this._whitescore);
  }
},
...
Dialog: {"": "Object;_memoTimer,_winTimer,_memo",
  write$1: function(text) {
    ...
    t1.i_0 = 0;
    this._memoTimer = P.Timer_Timer$periodic(C.Duration_90000, new T.Dialog_write_closure(t1, this, text));
  },
  writeWinner$1: function(color) {
    ...
    if ($._player === $.HUMAN) {
      t2 = color === C.Color_Black;
      text1 = "\\(>w<)/\\(>w<)/<br/><br/>&nbsp &nbsp &nbsp" + (t2 ? "Blue" : "Yellow") + " wins<br/><br/>\\(>w<)/\\(>w<)/_";
      text2 = "|(>w<)\\/(>w<)|<br/><br/>&nbsp &nbsp &nbsp" + (t2 ? "Blue" : "Yellow") + " wins<br/><br/>|(>w<)\\/(>w<)|";
      t1.i_0 = 0;
      this._winTimer = P.Timer_Timer$periodic(C.Duration_110000, new T.Dialog_writeWinner_closure(t1, this, text1, text2));
    }
    if ($._player === $.COMPUTER) {
      this._cancelTimers$0();
      if (color === C.Color_Black)
        J.set$innerHtml$x(this._memo, "You are so barbaric <img src = \"static/cry.gif\" alt = \"cry\"></img>  Play again! Play again!");
      else if (color === C.Color_White)
...
Dialog_write_closure: {"": "Closure;box_0,this_1,text_2",
  call$1: function(_) {
    ...
    t2 = this.text_2;
    t3 = this.box_0;
    t1._memo.textContent = C.JSString_methods.substring$2(t2, 0, t3.i_0) + "_";
    i = t3.i_0 + 1;
    t3.i_0 = i;
    if (i > t2.length)
...
Dialog_writeWinner_closure: {"": "Closure;box_0,this_1,text1_2,text2_3",
  call$1: function(timer) {
    var t1, t2, t3;
    t1 = this.this_1;
    if (t1._memoTimer == null) {
      t2 = this.box_0;
      t3 = C.JSInt_methods.$mod(t2.i_0, 2) === 0 ? this.text1_2 : this.text2_3;
      J.set$innerHtml$x(t1._memo, t3);
      t2.i_0 = t2.i_0 + 1;
      if (t2.i_0 === 100)
        t2.i_0 = 0;
    }
...
ComputerPlayer: {"": "Object;_bScoreOrigin,_wScoreOrigin",
  nextMove$2: function(board, level) {
    var levelNext, highScore, pos, i, j, tempBoard, score, t1;
    $._d1 = P.DateTime$_now();
    if (typeof level !== "number")
      throw level.$sub();
    levelNext = level - 1;
    for (highScore = null, pos = null, i = 0; i < 8; ++i)
      for (j = 0; j < 8; ++j) {
        tempBoard = T.Board$from(board);
        if (tempBoard.canPlace$2(new T.Offset(i, j), C.Color_White)) {
          tempBoard.placeChess$2(new T.Offset(i, j), C.Color_White);
          score = this.getHighScore$3(tempBoard, C.Color_Black, levelNext);
          if (highScore != null) {
  ...
  getHighScore$3: function(board, color, level) {
    var levelNext, t1, highScore, i, j, pos, tempBoard, score, t2;
    if (level === 0 || board.boardFull$0())
      return this.countscore$1(board);
    levelNext = level - 1;
    for (t1 = color === C.Color_Black, highScore = null, i = 0; i < 8; ++i)
      for (j = 0; j < 8; ++j) {
        pos = new T.Offset(i, j);
        tempBoard = T.Board$from(board);
        if (tempBoard.canPlace$2(pos, color)) {
          tempBoard.placeChess$2(pos, color);
          score = this.getHighScore$3(tempBoard, t1 ? C.Color_White : C.Color_Black, levelNext);
          if (t1) {
            if (tempBoard.aboveConer$2(i, j)) {
              if (typeof score !== "number")
                throw score.$add();
              score += 500;
            }
  ...
  countscore$1: function(board) {
    var score, i, j, t1, add;
    for (score = 0, i = 0; i < 8; ++i)
      for (j = 0; j < 8; ++j) {
        t1 = board._board;
        t1.length;
        t1 = t1[i];
  ...
  computerwrite$4: function(_dialog, nextcolor, bScore, wScore) {
    ...
    if (t1 == null || this._wScoreOrigin == null) {
      if (nextcolor === C.Color_White)
        _dialog.write$1("Let me think...");
      else if (nextcolor === C.Color_Black)
        _dialog.write$1("Your turn");
    } else if (nextcolor === C.Color_White) {
...
Alert: {"": "Object;_alt,clickTimes,pastSeconds",
  alertPop$1: function(keepPlace) {
    ...
    if (keepPlace === C.Color_Black && $._player === $.COMPUTER)
    ...
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new T.Alert_alertPop_closure(this, keepPlace)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    P.Timer_Timer$periodic(C.Duration_3500000, new T.Alert_alertPop_closure0(this, keepPlace));
  }
},
...
Alert_alertPop_closure: {"": "Closure;this_0,keepPlace_1",
  call$1: function(evt) {
    ...
    if (t1.clickTimes === 0) {
      t2 = $._player;
      if (t2 === $.HUMAN)
        J.set$innerHtml$x(t1._alt, "<br>" + (this.keepPlace_1 === C.Color_Black ? "Blue" : "Yellow") + "'s turn");
      else if (t2 === $.COMPUTER)
        J.set$innerHtml$x(t1._alt, "<br>" + (this.keepPlace_1 === C.Color_Black ? "Your" : "My") + " turn");
      t1.clickTimes = t1.clickTimes + 1;
      t1.pastSeconds = 1;
      return;
    }
    t2 = J.get$classes$x(t1._alt);
...
Alert_alertPop_closure0: {"": "Closure;this_2,keepPlace_3",
  call$1: function(timer) {
    ...
    if (t2 === 0) {
      t2 = $._player;
      if (t2 === $.HUMAN)
        J.set$innerHtml$x(t1._alt, (this.keepPlace_3 === C.Color_Black ? "Black" : "White") + "'s turn");
      else if (t2 === $.COMPUTER)
        J.set$innerHtml$x(t1._alt, (this.keepPlace_3 === C.Color_Black ? "Your" : "My") + " turn");
      t1.pastSeconds = t1.pastSeconds + 1;
      t1.clickTimes = t1.clickTimes + 1;
    } else if (t2 === 1) {
      t2 = J.get$classes$x(t1._alt);
      t2.remove$1(t2, "sbCannotChess_state2");
...
VisualBoard: {"": "Board;_parent,_hint,_cells,_dialog,_scoreboard,_alert,_computer,_computing,_level,EASY,MEDIUM,HARD,_board",
  _initElements$0: function() {
    var t1, t2, i, t3, ver, left, j, horz, $top, t4;
    for (t1 = this._cells, t2 = this._parent, i = 0; i < 8; ++i) {
      t1[i] = P.List_List(8, null);
      t3 = i === 0;
      ver = t3 ? "boardleft" : "";
      left = t3 ? 0 : (i - 1) * 70 + 71;
      for (j = 0; j < 8; ++j) {
        ...
        $top = t3 ? 0 : (j - 1) * 70 + 71;
        t3 = t1[i];
        t4 = new T.Cell(t2, null, null, null, null, $top, left, horz, ver);
        t4.create$0();
        t3.length;
        t3[j] = t4;
      }
    }
    this._placeOne$2(new T.Offset(3, 3), C.Color_Black);
    this._placeOne$2(new T.Offset(4, 4), C.Color_Black);
    this._placeOne$2(new T.Offset(3, 4), C.Color_White);
    this._placeOne$2(new T.Offset(4, 3), C.Color_White);
    this._updateHints$1(C.Color_Black);
  },
  _initEvents$0: function() {
    var t1, t2, t3;
    this._hint = document.querySelector("#hint");
    if (this._hint == null)
      P.print("where is hint?");
    t1 = this._hint;
    t1.toString;
    t2 = C.EventStreamProvider_click._eventType;
    t1 = new W._ElementEventStreamImpl(t1, t2, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new T.VisualBoard__initEvents_closure(this)), t1._useCapture);
    ...
    t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new T.VisualBoard__initEvents_closure0(this)), t2._useCapture);
  ...
  _clickInH2Human$1: function(pos) {
    ...
    currentColor = C.JSInt_methods.$mod($._times, 2) === 0 ? C.Color_Black : C.Color_White;
    if (this.canPlace$2(pos, currentColor)) {
      T.Board.prototype.placeChess$2.call(this, pos, currentColor);
      this._placeOne$2(pos, currentColor);
      nextColor = this._updateScore$1(currentColor);
      if (nextColor === currentColor) {
        this._alert.alertPop$1(currentColor);
        this._dialog.write$1((currentColor === C.Color_Black ? "Yellow" : "Blue") + " cannot place chess. " + H.S(currentColor) + "'s turn");
        ...
        $._times = $._times + 1;
        this._dialog.write$1(H.S(nextColor) + "'s turn");
      }
    }
  },
  _clickInH2Computer$1: function(pos) {
    var nextColor, t1;
    if (!this._computing && this.canPlace$2(pos, C.Color_Black)) {
      T.Board.prototype.placeChess$2.call(this, pos, C.Color_Black);
      this._placeOne$2(pos, C.Color_Black);
      nextColor = this._updateScore$1(C.Color_Black);
      if (nextColor === C.Color_White) {
        this._computing = true;
        t1 = this._scoreboard;
        this._computer.computerwrite$4(this._dialog, C.Color_White, t1._blackscore, t1._whitescore);
        P.Timer_Timer(C.Duration_800000, this.get$_computerPlace());
      } else if (nextColor == null) {
        this._endGame$0();
        return;
      } else if (nextColor === C.Color_Black) {
        this._dialog.write$1("wu~ wu~ I cannot Place chess ;A;");
        this._alert.alertPop$1(C.Color_Black);
      }
    }
  },
  _computerPlace$0: function() {
    var oft = this._computer.nextMove$2(this, this._level);
    P.Timer_Timer(P.Duration$(0, 0, $._d2.difference$1($._d1)._duration - P.Duration$(0, 0, 0, 1400, 0, 0)._duration, 0, 0, 0), new T.VisualBoard__computerPlace_closure(this, oft));
  },
  get$_computerPlace: function() {
    return new P.BoundClosure$0(this, T.VisualBoard.prototype._computerPlace$0, null, "_computerPlace$0");
  },
  _updateScore$1: function(currentColor) {
    ...
    if (this._isFinished$0())
      return;
    anotherColor = currentColor === C.Color_Black ? C.Color_White : C.Color_Black;
  ...
  _updateHints$2$checkOnly: function(color, checkOnly) {
    var t1, t2, num_can_set, i, j, pos, t3, t4;
    for (t1 = !checkOnly, t2 = this._cells, num_can_set = 0, i = 0; i < 8; ++i)
      for (j = 0; j < 8; ++j) {
        pos = new T.Offset(i, j);
  ...
  _placeOne$2: function(pos, color) {
    ...
    if (t1[t3] == null) {
      t1 = t4[t2];
      t1.length;
      t1[t3].addChess$1(color);
    } else {
      t1 = t4[t2];
      t1.length;
      t1[t3].changeChess$1(color);
    }
    T.Board.prototype._placeOne$2.call(this, pos, color);
  },
  _choosePlayer$0: function() {
    var p1, p2, t1, t2, t3;
    p1 = document.querySelector("#oneplayer");
    p2 = document.querySelector("#twoplayer");
    p1.toString;
    t1 = C.EventStreamProvider_click._eventType;
    t2 = new W._ElementEventStreamImpl(p1, t1, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new T.VisualBoard__choosePlayer_closure(this)), t2._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t3._tryResume$0();
    p2.toString;
    t1 = new W._ElementEventStreamImpl(p2, t1, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new T.VisualBoard__choosePlayer_closure0(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t3._tryResume$0();
  },
  _disChooseBoxP$0: function() {
    var p1, p2, t1;
    p1 = document.querySelector("#oneplayer");
    p2 = document.querySelector("#twoplayer");
    t1 = J.get$classes$x(p1);
    t1.add$1(t1, "disappear");
    t1 = J.get$classes$x(p2);
    t1.add$1(t1, "disappear");
    t1 = J.get$classes$x(document.querySelector(".playerchoice"));
    t1.add$1(t1, "disappear");
    t1 = J.get$classes$x(document.querySelector(".playerchoice1"));
    t1.add$1(t1, "disappear");
    t1 = J.get$classes$x(document.querySelector(".playerchoice2"));
    t1.add$1(t1, "disappear");
    if ($._player === $.COMPUTER) {
      t1 = J.get$classes$x(document.querySelector(".level"));
      t1.remove$1(t1, "disappear");
    } else {
  ...
  _chooseLevel$0: function() {
    var l1, l2, l3, d, t1, t2, t3;
    l1 = document.querySelector("#hard");
    l2 = document.querySelector("#medium");
    l3 = document.querySelector("#easy");
    d = document.querySelector("#levelDisplay");
    l1.toString;
    t1 = C.EventStreamProvider_click._eventType;
    t2 = new W._ElementEventStreamImpl(l1, t1, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new T.VisualBoard__chooseLevel_closure(this, d)), t2._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t3._tryResume$0();
    l2.toString;
    t3 = new W._ElementEventStreamImpl(l2, t1, false);
    H.setRuntimeTypeInfo(t3, [null]);
    t2 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new T.VisualBoard__chooseLevel_closure0(this, d)), t3._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
    t2._tryResume$0();
    l3.toString;
    t1 = new W._ElementEventStreamImpl(l3, t1, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new T.VisualBoard__chooseLevel_closure1(this, d)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
  },
  _disChooseBoxL$0: function() {
    var l1, l2, l3, t1;
    l1 = document.querySelector("#hard");
    l2 = document.querySelector("#medium");
    l3 = document.querySelector("#easy");
    t1 = J.get$classes$x(l1);
    t1.add$1(t1, "disappear");
    t1 = J.get$classes$x(l2);
    t1.add$1(t1, "disappear");
    t1 = J.get$classes$x(l3);
    t1.add$1(t1, "disappear");
    t1 = J.get$classes$x(document.querySelector("#bigShield"));
    t1.add$1(t1, "disappear");
    t1 = J.get$classes$x(document.querySelector(".level"));
    t1.add$1(t1, "disappear");
    t1 = J.get$classes$x(document.querySelector(".level1"));
    t1.add$1(t1, "disappear");
    t1 = J.get$classes$x(document.querySelector(".level2"));
    t1.add$1(t1, "disappear");
    t1 = J.get$classes$x(document.querySelector(".level3"));
    t1.add$1(t1, "disappear");
  },
  _endGame$0: function() {
    var t1, t2, a, restart;
    ...
    a = t2 - t1;
    if (a > 0)
      this._dialog.writeWinner$1(C.Color_Black);
    else {
      t1 = this._dialog;
      if (a === 0)
        t1.write$1("Duce. Let's play again");
      else
        t1.writeWinner$1(C.Color_White);
    }
    restart = document.querySelector("#restart");
    t1 = J.get$classes$x(restart);
    t1.add$1(t1, "restart");
    t1 = new W._ElementEventStreamImpl(restart, C.EventStreamProvider_click._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new T.VisualBoard__endGame_closure()), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
  }
},

VisualBoard__initEvents_closure: {"": "Closure;this_2",
  call$1: function(evt) {
    var t1, currentColor, box_1, t2, box_10, box_0, t3, box_00, t4;
    t1 = this.this_2;
    if (t1._computing)
      return;
    if ($._player === $.HUMAN)
      ...
      currentColor = C.Color_Black;
    box_1 = {};
    for (box_1.i_1 = 0, t2 = t1._cells; box_1.i_1 < 8; box_10 = {}, box_10.i_1 = box_1.i_1, box_10.i_1 = box_10.i_1 + 1, box_1 = box_10) {
      box_0 = {};
      for (box_0.j_0 = 0; t3 = box_0.j_0, t3 < 8; box_00 = {}, box_00.j_0 = box_0.j_0, box_00.j_0 = box_00.j_0 + 1, box_0 = box_00)
        if (t1.canPlace$2(new T.Offset(box_1.i_1, t3), currentColor)) {
          t3 = box_1.i_1;
          if (t3 < 0 || t3 >= 8)
            throw H.ioore(t2, t3);
          t3 = t2[t3];
          ...
          if (t4 < 0 || t4 >= 8)
            throw H.ioore(t3, t4);
          t3[t4].addHintAnimation$0();
          P.Timer_Timer(C.Duration_1000000, new T.VisualBoard__initEvents__closure0(box_1, box_0, t1));
        }
    }
  },
  $is_args1: true
...
VisualBoard__initEvents__closure0: {"": "Closure;box_1,box_0,this_3",
  call$0: function() {
    var t1, t2, t3;
    t1 = this.box_1.i_1;
    t2 = this.box_0.j_0;
    t3 = this.this_3._cells;
    if (t1 < 0 || t1 >= 8)
      throw H.ioore(t3, t1);
    t1 = t3[t1];
    t1.length;
    if (t2 < 0 || t2 >= 8)
      throw H.ioore(t1, t2);
    t1[t2].removeHintAnimation$0();
  }
},

VisualBoard__initEvents_closure0: {"": "Closure;this_4",
  call$1: function(evt) {
    var t1, t2, t3, t4, t5, pos;
    t1 = J.getInterceptor$x(evt);
    t2 = J.get$x$x(t1.get$page(evt));
    t3 = this.this_4;
    t4 = t3._parent;
    t5 = t4.offsetLeft;
    if (typeof t2 !== "number")
    ...
    if (typeof t5 !== "number")
      throw H.iae(t5);
    t5 = C.JSNumber_methods.toInt$0((t2 - t5) / 70);
    t1 = J.get$y$x(t1.get$page(evt));
    t4 = t4.offsetTop;
    if (typeof t1 !== "number")
      throw t1.$sub();
    if (typeof t4 !== "number")
      throw H.iae(t4);
    pos = new T.Offset(t5, C.JSNumber_methods.toInt$0((t1 - t4) / 70));
    t1 = pos.x;
    if (t1 < 0)
      pos.x = 0;
    else if (t1 > 7)
    ...
    if (t1 < 0)
      ...
      pos.y = 7;
    P.Future_Future(new T.VisualBoard__initEvents__closure(t3, pos), null);
  },
  $is_args1: true
},

VisualBoard__initEvents__closure: {"": "Closure;this_5,pos_6",
  call$0: function() {
    var t1, t2;
    t1 = this.this_5;
    t2 = this.pos_6;
...
VisualBoard__computerPlace_closure: {"": "Closure;this_0,oft_1",
  call$0: function() {
    var t1, t2, nextColor;
    t1 = this.this_0;
    t2 = this.oft_1;
    T.Board.prototype.placeChess$2.call(t1, t2, C.Color_White);
    t1._placeOne$2(t2, C.Color_White);
    nextColor = t1._updateScore$1(C.Color_White);
    if (nextColor !== C.Color_White) {
      t1._computing = false;
      if (nextColor == null) {
        t1._endGame$0();
      ...
      t2 = t1._scoreboard;
      t1._computer.computerwrite$4(t1._dialog, C.Color_Black, t2._blackscore, t2._whitescore);
      return;
    }
    t1._alert.alertPop$1(C.Color_White);
    t1._dialog.write$1("Haha~ It's my turn again B-)");
    P.Timer_Timer(C.Duration_800000, t1.get$_computerPlace());
  }
},

VisualBoard__choosePlayer_closure: {"": "Closure;this_0",
  call$1: function(evt) {
    var t1;
    $._player = $.COMPUTER;
    t1 = this.this_0;
    t1._disChooseBoxP$0();
    t1._chooseLevel$0();
    t1._dialog.write$1("You go first");
  },
  $is_args1: true
},

VisualBoard__choosePlayer_closure0: {"": "Closure;this_1",
  call$1: function(evt) {
    var t1;
    $._player = $.HUMAN;
    t1 = this.this_1;
    t1._disChooseBoxP$0();
    t1._dialog.write$1("Blue first");
    J.set$innerHtml$x(document.querySelector("#levelDisplay"), "Level:&nbsp&nbsp-&nbsp-&nbsp-&nbsp-&nbsp-&nbsp-");
  },
  $is_args1: true
},

VisualBoard__chooseLevel_closure: {"": "Closure;this_0,d_1",
  call$1: function(evt) {
    var t1 = this.this_0;
    t1._level = t1.HARD;
    J.set$innerHtml$x(this.d_1, "Level:&nbspChrysalis");
    t1._disChooseBoxL$0();
  },
  $is_args1: true
},

VisualBoard__chooseLevel_closure0: {"": "Closure;this_2,d_3",
  call$1: function(evt) {
    var t1 = this.this_2;
    t1._level = t1.MEDIUM;
    J.set$innerHtml$x(this.d_3, "Level:&nbsp &nbsp &nbspLarvae");
    t1._disChooseBoxL$0();
  },
  $is_args1: true
},

VisualBoard__chooseLevel_closure1: {"": "Closure;this_4,d_5",
  call$1: function(evt) {
    var t1 = this.this_4;
    t1._level = t1.EASY;
    J.set$innerHtml$x(this.d_5, "Level:&nbsp &nbsp &nbsp &nbsp  &nbspEgg");
    t1._disChooseBoxL$0();
  },
  $is_args1: true
},
...
T.Cell.$isCell = true;
T.Cell.$isObject = true;
T.Offset.$isOffset = true;
T.Offset.$isObject = true;
...
C.Color_Black = new T.Color("Black");
C.Color_White = new T.Color("White");
C.Duration_0 = new P.Duration(0);
C.Duration_1000000 = new P.Duration(1000000);
C.Duration_110000 = new P.Duration(110000);
C.Duration_3000000 = new P.Duration(3000000);
C.Duration_3500000 = new P.Duration(3500000);
C.Duration_800000 = new P.Duration(800000);
C.Duration_90000 = new P.Duration(90000);
...
Isolate.$lazy($, "_allOfs", "_allOfs", "get$_allOfs", function() {
  return [new T.Offset(-1, 0), new T.Offset(-1, 1), new T.Offset(0, 1), new T.Offset(1, 1), new T.Offset(1, 0), new T.Offset(1, -1), new T.Offset(0, -1), new T.Offset(-1, -1)];
});
Isolate.$lazy($, "_scores", "_scores", "get$_scores", function() {
  return [[900, -10, 90, 50, 50, 90, -10, 900], [-10, -250, 10, 20, 20, 10, -250, -10], [90, 10, 50, 30, 30, 50, 10, 90], [50, 20, 30, 20, 20, 30, 20, 50], [50, 20, 30, 20, 20, 30, 20, 50], [90, 10, 50, 30, 30, 50, 10, 90], [-10, -250, 10, 20, 20, 10, -250, -10], [900, -10, 90, 50, 50, 90, -10, 900]];
});
// Native classes
